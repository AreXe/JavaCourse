...
public class Game {
     ...
     */
    public String checkGameWinner(char [][]grid){ //Logic of the TicTacToe game
        String result = "None";
        if (grid[0][0] == grid[1][0] && grid[1][0] == grid[2][0] && grid[0][0]!='-') result = Character.toString(grid[0][0]).toUpperCase()+ " wins";
        if (grid[0][1] == grid[1][1] && grid[1][1] == grid[2][1] && grid[0][1]!='-') result = Character.toString(grid[0][1]).toUpperCase()+ " wins";
        if (grid[0][2] == grid[1][2] && grid[1][2] == grid[2][2] && grid[0][2]!='-') result = Character.toString(grid[0][2]).toUpperCase()+ " wins";
        if (grid[0][0] == grid[0][1] && grid[0][1] == grid[0][2] && grid[0][0]!='-') result = Character.toString(grid[0][0]).toUpperCase()+ " wins";
        if (grid[1][0] == grid[1][1] && grid[1][1] == grid[1][2] && grid[1][0]!='-') result = Character.toString(grid[1][0]).toUpperCase()+ " wins";
        if (grid[2][0] == grid[2][1] && grid[2][1] == grid[2][2] && grid[2][0]!='-') result = Character.toString(grid[2][0]).toUpperCase()+ " wins";
        if (grid[0][0] == grid[1][1] && grid[1][1] == grid[2][2] && grid[0][0]!='-') result = Character.toString(grid[0][0]).toUpperCase()+ " wins";
        if (grid[2][0] == grid[1][1] && grid[1][1] == grid[0][2] && grid[2][0]!='-') result = Character.toString(grid[2][0]).toUpperCase()+ " wins";
        else if ((result == "None") && freeSpots==0) result="Tie";
        return result;
    }
